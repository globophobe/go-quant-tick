...
SERVICE_ENV ?=
SERVICE_ENV_VARS := PUBLISH_STREAMS SIGNIFICANT_TRADE_FILTER BINANCE_SYMBOLS BINANCE_FUTURES_SYMBOLS BITFINEX_SYMBOLS BITMEX_SYMBOLS COINBASE_SYMBOLS HYPERLIQUID_SYMBOLS RAW_TRADES_TOPIC AGGREGATED_TRADES_TOPIC SIGNIFICANT_TRADES_TOPIC SHUTDOWN_FLUSH_TIMEOUT SENTRY_DSN
