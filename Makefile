...
SERVICE_ENV ?=
SERVICE_ENV_VARS := WEBSOCKET_DATA_STREAMS SIGNIFICANT_TRADE_FILTER BINANCE_SYMBOLS BINANCE_FUTURES_SYMBOLS BYBIT_SYMBOLS BITFINEX_SYMBOLS BITMEX_SYMBOLS COINBASE_SYMBOLS HYPERLIQUID_SYMBOLS PRODUCTION_DATABASE_HOST DATABASE_USER DATABASE_NAME FLUSH_TIMEOUT SHUTDOWN_FLUSH_TIMEOUT SENTRY_DSN
